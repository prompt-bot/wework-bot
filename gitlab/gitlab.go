		...
		message = weworkapi.MessageMarkdown{
			...
			Markdown: weworkapi.Markdown{
				Content: fmt.Sprintf(
					...
					weworkapi.MarkDownMessageLink(payload.Commit.Message, payload.Commit.URL),
		...
		message = weworkapi.MessageMarkdown{
			...
			Markdown: weworkapi.Markdown{
				Content: fmt.Sprintf(
					...
					weworkapi.MarkDownMessageLink(payload.ObjectAttributes.LastCommit.Message, payload.ObjectAttributes.LastCommit.URL),
